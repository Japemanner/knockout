...
export function BoardCard({ id, name, is_inbox }: BoardCardProps) {
          ...
          <Card className="hover:border-primary transition-colors cursor-pointer h-full">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                {is_inbox ? 'Inbox — quick capture bestemming' : 'Kanban-bord'}
              </p>
            </CardContent>
          </Card>
        </Link>
      ...
      <Dialog open={showDelete} onOpenChange={setShowDelete}>
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Weet je zeker dat je &quot;{name}&quot; wilt verwijderen? Alle kolommen en kaarten worden ook verwijderd. Dit kan niet ongedaan worden gemaakt.
          </p>
